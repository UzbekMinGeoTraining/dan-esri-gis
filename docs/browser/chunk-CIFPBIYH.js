...
return (t * t * t) * (t * (t * 6.0 - 15.0) + 10.0);
  ...
  `),o.mode===l.Full?t.fragment.main.add(e`
      ...
      map = remap(map, 0.25 * (1.0 - worley(8.0 * mapUV)), 1.0, 0.0, 1.0);
      fragColor = vec4(map);
    `),t}var M=Object.freeze(Object.defineProperty({__proto__:null,NoiseTextureAtlasPassParameters:p,build:w},Symbol.toStringTag,{value:"Module"}));export{l as a,d as b,p as c,w as d,M as e};
