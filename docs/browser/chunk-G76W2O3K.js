import{a as P}from"./chunk-KGCWA4JJ.js";import{a as f,b as z,c as E,d as n,g as C}from"./chunk-4USQQEIR.js";import{b as m}from"./chunk-E3LKQDEM.js";import{a as R,b as d}from"./chunk-J7UK2QPE.js";import{a as w}from"./chunk-KQHYII76.js";import{a as x}from"./chunk-RNN6GAXL.js";import{a as T}from"./chunk-4IVMQ5PX.js";import{a as b}from"./chunk-CQUOQXLP.js";import{a as D}from"./chunk-S3J33BKD.js";import{a as i}from"./chunk-2HN33SWB.js";import{a as S,b as e}from"./chunk-BXR2KKYP.js";import{a as v}from"./chunk-DBLGLVAQ.js";import{a as y}from"./chunk-HWN5REN7.js";import{b as g}from"./chunk-XTES2GPX.js";import{f as s}from"./chunk-5PTS4JDF.js";import{a as u}from"./chunk-BMVJCP2M.js";import{a as h}from"./chunk-BP73DJTS.js";var r;(function(a){a[a.SIXTEEN=0]="SIXTEEN",a[a.HUNDRED=1]="HUNDRED",a[a.TWOHUNDRED=2]="TWOHUNDRED",a[a.COUNT=3]="COUNT"})(r||(r={}));var l=class extends R{constructor(){super(...arguments),this.steps=r.SIXTEEN,this.writeTextureChannels=m.RG}};u([d({count:r.COUNT})],l.prototype,"steps",void 0),u([d({count:m.COUNT})],l.prototype,"writeTextureChannels",void 0);var p=class extends S{constructor(){super(...arguments),this.cloudRadius=0,this.cloudSize=0,this.detailSize=0,this.absorption=0,this.density=0,this.smoothness=0,this.cloudHeight=0,this.coverage=0,this.viewMatrix=v()}},H=h("esri-mobile")?1024:2048;function M(a){let c=new b;c.include(w,!1);let o=c.fragment;return o.include(P),o.uniforms.add(new i("cloudRadius",t=>t.cloudRadius),new i("power",t=>s(35,120,t.absorption)),new i("sigmaE",t=>1+t.absorption),new i("density",t=>s(0,.3,t.density)),new i("cloudSize",t=>s(0,.02,Math.max(.01,1-t.cloudSize))),new i("detailSize",t=>s(0,.2,Math.max(.01,1-t.detailSize))),new i("smoothness",t=>s(0,.5,1-t.smoothness)),new i("cloudHeight",t=>s(0,1500,t.cloudHeight)),new i("coverage",t=>t.coverage),new D("view",t=>t.viewMatrix),new T("cloudShapeTexture",t=>t.noiseTexture!=null?t.noiseTexture.textureAtlas:null),new x("cloudVariables",t=>g(F,t.coverage,t.absorption))),o.constants.add("halfCubeMapSize","float",.5*H),o.code.add(e`
...
fragColor = vec4(shading, totalTransmittance, shading, totalTransmittance);`),c}var F=y(),K=Object.freeze(Object.defineProperty({__proto__:null,CloudsPassParameters:p,build:M,cubeMapSize:H},Symbol.toStringTag,{value:"Module"}));export{r as a,l as b,p as c,H as d,M as e,K as f};
