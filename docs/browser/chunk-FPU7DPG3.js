...
return setLum(sbase > 0.0 ? (cbase - minbase) * ssat / sbase : vec3(0.0), clum);
  ...
  `))}function eo(o,l){let r=l.output===t.GridComposite,d=l.output===t.ColorComposite,f=l.output===t.GroupBackgroundComposite,g=l.output===t.Composite,s=l.baseOpacityMode===b.Required,i=o.fragment;s&&i.uniforms.add(new n("baseOpacity",a=>a.baseOpacity)),r?i.include(x):d?i.uniforms.add(new C("backgroundColor",a=>a.backgroundColor)):g&&i.uniforms.add(new y("fboColor",a=>a.fboTexture));let p=l.blendMode!==e.Normal,D=l.premultipliedSource===u.On,B=!p&&!D&&(g&&!s||f);i.include(S,l),i.code.add(c`
    ...
    }`)}export{O as a,U as b,e as c,R as d,V as e,b as f,t as g,u as h,eo as i};
