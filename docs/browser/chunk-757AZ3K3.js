import{a as u}from"./chunk-OO4IIGVK.js";import{a as f}from"./chunk-RNN6GAXL.js";import{a as g}from"./chunk-VI4TDFI5.js";import{a as d,b as a,c as s}from"./chunk-BXR2KKYP.js";import{a as h}from"./chunk-HWN5REN7.js";import{a as m}from"./chunk-YRTBL7EE.js";import{c as i}from"./chunk-PYQRTZNZ.js";import{b as p}from"./chunk-5PTS4JDF.js";import{a as o}from"./chunk-VPXBKZQM.js";function I(e){return p((e-1e5)/9e5,0,1)}var R=1e4,r=i(parseFloat(5802e-9.toFixed(6)),parseFloat(13558e-9.toFixed(6)),parseFloat(331e-7.toFixed(6))),n=3,l=i(n*parseFloat(65e-8.toFixed(6)),n*parseFloat(1881e-9.toFixed(6)),n*parseFloat(85e-9.toFixed(6))),y=3996e-9,P=i(parseFloat(Number(r[0]+l[0]).toFixed(6)),parseFloat(Number(r[1]+l[1]).toFixed(6)),parseFloat(Number(r[2]+l[2]).toFixed(6)));var x=class extends d{constructor(){super(...arguments),this.radii=h(),this.heightParameters=m()}};function b(e){e.uniforms.add(new f("radii",t=>t.radii),new u("heightParameters",t=>t.heightParameters)),e.constants.add("scaleHeight","float",o.scaleHeight*o.atmosphereHeight),e.code.add(a`float chapmanApproximation(float thickness, float height, float cosZenith) {
...
return vec4(0.0, hitsPlanet ? 1.0 : 0.0, start, end);
}`)}function E(e,t){e.include(b);let c=6;e.uniforms.add(new g("cameraPosition",(F,D)=>D.camera.eye)),e.constants.add("betaRayleigh","vec3",r),e.constants.add("betaCombined","vec3",P),e.constants.add("betaMie","float",y),e.code.add(a`
    ...
    }`)}export{I as a,R as b,x as c,E as d};
