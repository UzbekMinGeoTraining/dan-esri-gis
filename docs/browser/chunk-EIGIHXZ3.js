import{a as c}from"./chunk-KQHYII76.js";import{a as s}from"./chunk-4IVMQ5PX.js";import{a as x}from"./chunk-CQUOQXLP.js";import{b as e}from"./chunk-BXR2KKYP.js";var t=8,d=16;function i(){let o=new x;return o.include(c),o.fragment.uniforms.add(new s("edgesTexture",r=>r.inputTexture),new s("areaTexture",r=>r.areaTexture),new s("searchTexture",r=>r.searchTexture)),o.fragment.code.add(e`
    ...
    vec2 getArea(sampler2D areaTex, vec2 dist, float e1, float e2, float offset) {
      vec2 texcoord = float(${e.int(d)}) * round(4.0 * vec2(e1, e2)) + dist;
    ...
    fragColor = weights;
  `),o}var l=Object.freeze(Object.defineProperty({__proto__:null,build:i},Symbol.toStringTag,{value:"Module"}));export{i as a,l as b};
